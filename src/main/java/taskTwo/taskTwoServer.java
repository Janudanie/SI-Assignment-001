...
public class taskTwoServer
{
    ...
    public static void listenForNewClient() throws UnknownHostException, IOException{
        //Main program will halt here, waiting for a new client
    ...
    public static void main(String[] args) throws IOException
    {
        try
        {
            ...
            while(true){
                listenForNewClient();
                new Thread(new taskTwoThreadServer(openSocket)).start();
            }
        }
        catch(Exception e)
        {
